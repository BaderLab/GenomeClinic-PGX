...
var convertAlleles = function(ref,alt){
	var tempRefAllele = undefined;  //the priority will be to assign a value to the ref. tehrefore if there is an INSERTION
								    //AND deletion, the default will be to add an allele to the INSERTION
	var tempModifier = undefined;
	var tempAlts = [];
	var tempRefs = [];
	var tempModifierArray = [];
	var tempAlts = alt.map(function(item){
