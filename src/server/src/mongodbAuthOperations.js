...
module.exports = function(dbOperations){
	...
	dbOperations.prototype.addUser = function(user){
	...
	dbOperations.prototype.findUserById = function(id){
	...
	dbOperations.prototype.validatePassword = function(username,password){
	...
	dbOperations.prototype.findUserByGoogleId = function(id){
		assert(Object.prototype.toString.call(id) == "[object String]",
			"Invalid Options");
		var query = {};
	...
	dbOperations.prototype.addUserGoogle = function(user){
	...
	dbOperations.prototype.generatePassword = function(user){
	...
	dbOperations.prototype.changePassword = function(user, password){
		assert(Object.prototype.toString.call(user) == "[object String]",
			"Invalid Options");
		assert(Object.prototype.toString.call(password) == "[object String]",
			"Invalid Options");
