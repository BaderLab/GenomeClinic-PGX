 ...
 */
var count = function(collectionName){
	var promise = new Promise(function(resolve,reject){
...
var findUserByEmail = function(email){
	assert.notStrictEqual(db, undefined);
	assert(Object.prototype.toString.call(email) == "[object String]",
		"Invalid Options");
...
var addUser = function(user){
	...
	var doc = {}
	doc[dbConstants.USER_ID_FIELD] = username;
	doc[dbConstants.USER_PASSWORD_FIELD] = bcrypt.hashSync(password, bcrypt.genSaltSync(8), null);
	return insert(dbConstants.USER_COLLECTION_ID,doc);

};

var validatePassowrd = function(username,password){
	assert.notStrictEqual(db, undefined);
...
var addUserGoogle = function(user){
	...
	assert(Object.prototype.toString.call(user[dbConstants.USER_ID_FIELD]) == "[object String]",
		"Invalid Options");
	user[dbConstants.USER_ID_FIELD] = user.email;
