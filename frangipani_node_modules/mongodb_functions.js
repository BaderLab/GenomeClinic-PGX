...
var createInitCollections= function(callback) {
	...
	db.collection(dbConstant.ADMIN_COLLECTION_ID).insert(currentDocument);
	...
	db.collection(dbConstant.PATIENTS_COLLECTION_ID).ensureIndex(currentDocument, {unique: true},
		function() {
			var currentDocument= {};
...
var addPatient= function(patientID) {
	...
	db.collection(dbConstant.ADMIN_COLLECTION_ID).findOne({}, function(err, doc) {
		...
		db.collection(dbConstant.PATIENTS_COLLECTION_ID).insert(currentDocument, function(err, result) {
			assert.equal(err, null);
