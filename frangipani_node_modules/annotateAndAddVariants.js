...
function annotateAndAddVariants(options){
	...
	var promise = new Promise(function(resolve,reject){
		...
		.then(function(result){
			...
			logMessage('Renaming ' + inputFile + ' to ' + newFile);
			...
			logMessage("Performing Checks and creating Collections");
			...
			var promise = new Promise(function(resolve,reject){
				...
				ps.on('exit',function(code){
					if (code ==0){
						logMessage('Annovar annotations now complete');
						resolve(code);
					} else {
			...
			var promise = new Promise(function(resolve, reject){
				...
				ps.on('exit',function(code){
					if (code == 0){
						logMessage("Parser exited Properly, reading program output")
			...
			logMessage("Comparing databse to vcf file");
			...
			logMessage("Addding indexes to newly created collections");
			...
			logMessage("Removing generated files")
